 ...
 *  a list of user names that s/he follows, and the list's size. */
 public class User {
    ...
    public boolean follows(String name) {
        ...
        for (int i = 0; i < this.fCount; i++) { //CREATING A FORLOOP WHICH RUN ALL OVER THE ARRAY 
                if (name.equals(this.follows[i])) { // CHECKS IF THE "NAME" IS APPEARS IN THE ARRAY 
                    return true;
                }
        }
    ...
    public boolean removeFollowee(String name) {
        ...
        for (int i = 0; i < this.fCount; i++) { //GOING ALL OVER THE ARRAY 
        if ( name.equals(this.follows[i])) { //IF THE GIVEN NAME IS IN THE ARRAY 
            this.follows[i] = this.follows[this.fCount-1]; //REPLACE IT IN THE ARRAY WITH "null"
